...
K_POINTS {{automatic}}
6 6 6 0 0 0
""".format(_calculation=calculation, _prefix=name, _masses=masses, _nat=nat, _ntyp=ntyp, _atomic_positions=atomic_positions, _lattice=lattice)
    ...
    # Get the output data (MANUALLY FOR NOW)
    record = False
